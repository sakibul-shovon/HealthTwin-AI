...
export default function VoicePanel({
  ...
  const voiceEnabled = useTwinStore((s) => s.voiceEnabled);
  const toggleVoice = useTwinStore((s) => s.toggleVoice);
    ...
    <div className="flex flex-col gap-2.5 w-full">
      ...
      >
        ...
        <motion.button
          ...
          style={{
            background: voiceEnabled ? "var(--primary-tint)" : "var(--surface-sunk)",
            color: voiceEnabled ? "var(--primary)" : "var(--ink-faint)",
          }}
          whileTap={{ scale: 0.9 }}
          title={voiceEnabled ? "Voice on — tap to mute" : "Voice muted — tap to unmute"}
        >
          {voiceEnabled ? (
